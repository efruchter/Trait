...
public class Entity {
    ...
    public void setRenderBehavior(final RenderBehavior renderBehavior) {
    ...
    public void reset() {
        ...
        setRenderBehavior(DEFAULT_RENDER);
        setActive(hasStarted = false);
    }

    public void draw(final Graphics2D g) {
        if (renderBehavior != null) {
            renderBehavior.render(this, g);
        }
    }

    public final static RenderBehavior DEFAULT_RENDER = new RenderBehavior() {

        @Override
        public void render(final Entity entity, final Graphics2D g) {
            g.setColor(entity.baseColor);
            g.fillOval((int) (entity.x - entity.radius),
