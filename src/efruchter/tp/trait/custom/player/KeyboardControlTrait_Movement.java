...
public class KeyboardControlTrait_Movement extends Trait {
	...
	public KeyboardControlTrait_Movement() {
		...
		registerGene(drag = GeneVectorIO.getExplorationVector().storeGene("player.move.drag", new Gene("Air Drag", "Amount of air drag."),
		        false));
		registerGene(thrust = GeneVectorIO.getExplorationVector().storeGene("player.move.thrust",
